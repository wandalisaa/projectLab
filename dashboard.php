        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif ?>
                    <a href="form-list.php?aksi=edit&id=" class="btn btn-info float-right mx-1" >
                    ...
                    <a onclick="" href="list.php?aksi=hapus&id=" class="btn btn-danger text-white float-right mx-1" data-toggle="tooltip" data-placement="bottom" title="Hapus">
