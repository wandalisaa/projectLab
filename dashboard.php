...
<?php
     $data = $conn->query("SELECT * FROM todo t WHERE 1 ORDER BY t.status");
...
<div class="container" style="min-height: 100vh;">
    ...
    <div class="row mb-5">
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                <h5 class="card-header w-100">kategori
                <span class="badge badge-primary ml-auto">status
            </span>
        </h5>
                <div class="card-body">
                    ...
                    <div class="w-100 mb-2">
                        <a href="#" class="badge badge-dark">tempat</a>
                        <a href="#" class="badge badge-light">waktu</a>
                    </div>
                    <a href="list.php?aksi=edit&id=" class="btn btn-info float-right mx-1" >
                    ...
                    <a href="" class="btn btn-danger text-white float-right mx-1" data-toggle="tooltip" data-placement="bottom" title="Hapus">
