        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="list.php?aksi=hapus&id=<?=$list['id']?>" class="confirmation btn btn-danger text-white float-right mx-1" data-toggle="tooltip" data-placement="bottom" title="Hapus">
