...
<div class="container" style="min-height: 100vh;">
    <div class="jumbotron bg-light text-dark">
        <div class="avatar" style="background-image: url('asset/upload/<?=$_SESSION['foto']?>'); width:200px;height:200px"></div>
    ...
    <div class="row">
        <a href="form-list.php?aksi=tambah" class="btn btn-primary my-3 ml-auto">Tambah List</a>
    </div>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="list.php?aksi=selesai&id=<?=$list['id']?>" class="btn btn-primary float-right mx-1" data-toggle="tooltip" data-placement="bottom" title="Selesai">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square-fill" viewBox="0 0 16 16">
                            <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z" />
                        </svg>
                    </a>
                    <?php endif ?>
                    <a href="form-list.php?aksi=edit&id=<?=$list['id']?>" class="btn btn-info float-right mx-1" >
                    ...
                    <a onclick="confirm('Apakah anda yakin ingin menghapus record ini ?')" href="list.php?aksi=hapus&id=<?=$list['id']?>" class="btn btn-danger text-white float-right mx-1" data-toggle="tooltip" data-placement="bottom" title="Hapus">
